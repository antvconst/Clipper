...
quint32 QxtGlobalShortcutPrivate::nativeKeycode(Qt::Key key, Qt::KeyboardModifiers modifiers)
{
	...
	switch (key)
	{
		...
		case Qt::Key_Equal:
			return (modifiers & Qt::KeypadModifier) ? kVK_ANSI_KeypadEquals : kVK_ANSI_Equal;
		case Qt::Key_9:
		...
		case Qt::Key_Minus:
			return (modifiers & Qt::KeypadModifier) ? kVK_ANSI_KeypadMinus : kVK_ANSI_Minus;
		case Qt::Key_8:
		...
		case Qt::Key_Slash:
			return (modifiers & Qt::KeypadModifier) ? kVK_ANSI_KeypadDivide : kVK_ANSI_Slash;
		case Qt::Key_N:
			return kVK_ANSI_N;
		case Qt::Key_M:
			return kVK_ANSI_M;
		case Qt::Key_Period:
			return (modifiers & Qt::KeypadModifier) ? kVK_ANSI_KeypadDecimal : kVK_ANSI_Period;
